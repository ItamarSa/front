    ...
    return (
        ...
        >
                ...
                <div className="main-nav">
                    <div>
                        <NavLink className="btn" title="home" to="/">
                            <h1 className={`logo  ${(isHomePage && scrollingHeader && window.scrollY > 25) || (!isHomePage || window.innerWidth < 768) ? "scrolling" : ""}`}>Tenner</h1>
                    ...
                    <div className="search-text">
                        {showFilter && <TextFilter handleFilterChange={handleFilterChange} />}
                    </div>
            ...
            <div className={`filter-container main-container full ${scrollingNav ? 'scrolling' : ""}`}>
                ...
                {showTagFilter && <TagFilter handleFilterChange={handleFilterChange} />}
