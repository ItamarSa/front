                            ...
                            <section class="billing-info-wrapper">
                                ...
                                <div class="p-20">
                                    <div class="flex-col">
                                        ...
                                        <div><button class="FW1syM7 Af0hvld xaFER3a co-grey-1200 payment-page-h-42 payment-page-max-w-fit-content">Add details</button></div>
                        ...
                        <div className="side-content">
                            <section class="summary">
                                ...
                                <section class="currency-section">
                                    ...
                                    class="price">₪249.42</span>. Total amount includes currency conversion fees.</div></section>
                            </section>
