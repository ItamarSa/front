    ...
    return (
        <section className='gigs-card'>
            ...
            <div className="mini-user-preview">
                <div className="left-content">
                    <div className='left-user flex'>
                        <img src={gig.sellerUrl} alt="user-img" className="mini-img" />
                        <Link className='gig-details' to={`/user/${gig.owner._id}`}><span className='user-name'>{gig.name}</span></Link>
                    </div>
                </div>
            ...
            <div className='gig-rate flex'>
                ...
                <b> {gig.rate} </b>
                <span className="review-length">({gig.reviews})</span>
            </div>
