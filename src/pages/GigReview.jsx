                        ...
                        <table className="star-counter">
                            <tbody>
                                <tr>
                                    ...
                                    <td className="rate-count">({(0.8 * gig.owner.reviews).toFixed(0)})</td>
                                </tr>
                                <tr>
                                    <td className="star-num">
                                        <span>4 Stars</span>
                                    ...
                                    <td className="rate-count">({(0.15 * gig.owner.reviews).toFixed(0)})</td>
                                </tr>
                                <tr>
                                    <td className="star-num">
                                        <span>3 Stars</span>
                                    ...
                                    <td className="rate-count">({(0.05 * gig.owner.reviews).toFixed(0)})</td>
                                </tr>
                                <tr>
                                    <td className="star-num">
                                        <span>2 Stars</span>
