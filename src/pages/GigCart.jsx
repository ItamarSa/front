...
const vSymbol = <svg width="16" height="16" viewBox="0 0 11 9" xmlns="http://www.w3.org/2000/svg" fill="#222325"><path d="M3.645 8.102.158 4.615a.536.536 0 0 1 0-.759l.759-.758c.21-.21.549-.21.758 0l2.35 2.349L9.054.416c.21-.21.55-.21.759 0l.758.758c.21.21.21.55 0 .759L4.403 8.102c-.209.21-.549.21-.758 0Z"></path></svg>
...
export function GigCart({ gig, scrollToAboutSeller }) {
        ...
        <section className='main-cart'>
                ...
                <div className="content-container">
                        ...
                        <article>
                            <div className="content">
                                <div className="title-content">
                                    <div className="type"><b>BASIC PACKAGE</b></div>
                                    <div className="price"><span>{'US$' + gig.price}</span></div>
                                </div>
                                <p className="cart-gig-title">1 Page Website (1-3 sections), Basic SEO optimized, Responsive Design, Social Media</p>
                                ...
                                {list && (
                                    <ul className="package-include clean-list">
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> 1 concept included</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Logo transparency</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Vector file</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Printable file</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Include 3D mockup</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Include source file</li>
                                    </ul>
                                )}
                            </div>
                    ...
                    {activeTab === "standard" && (
                        <article>
                            <div className="content">
                                <div className="title-content">
                                    <div className="type"><b>STANDARD PACKAGE ( Best selling )</b></div>
                                    <div className="price"><span>{'US$' + gig.price * 1.5}</span></div>
                                </div>
                                <p className="cart-gig-title">3 Page Website (1-3 sections), Basic SEO optimized, Responsive Design, Social Media</p>
                                ...
                                {list && (
                                    <ul className="package-include clean-list">
                                        <li className="serve flex align-center" ><span className="v-svg" >{vSymbol}</span> 2 concept included</li>
                                        <li className="serve flex align-center" ><span className="v-svg" >{vSymbol}</span> Logo transparency</li>
                                        <li className="serve flex align-center" ><span className="v-svg" >{vSymbol}</span> Vector file</li>
                                        <li className="serve flex align-center" ><span className="v-svg" >{vSymbol}</span> Printable file</li>
                                        <li className="serve flex align-center" ><span className="v-svg" >{vSymbol}</span> Include 3D mockup</li>
                    ...
                    {activeTab === "premium" && (
                        <article>
                            <div className="content">
                                <div className="title-content">
                                    <div className="type"><b>PREMIUM PACKAGE</b></div>
                                    <div className="price"><span>{'US$' + gig.price * 2}</span></div>
                                </div>
                                <p  className="cart-gig-title">5 Page Website (1-3 sections), Basic SEO optimized, Responsive Design, Social Media</p>
                                ...
                                {list && (
                                    <ul className="package-include clean-list">
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> 3 concept included</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Logo transparency</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Vector file</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Printable file</li>
                                        <li className="serve flex align-center" ><span className="v-svg">{vSymbol}</span> Include 3D mockup</li>
            ...
            <div className="contact-me">
                ...
                <span className="seller-popover-content">
                    <button className="seller-options" onClick={scrollToAboutSeller}/*onClick={handleContactMeClick}*/>
